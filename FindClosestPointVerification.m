...
p=zeros(20,3);
p(1,:)=[2.5 2.5 6.5];%[2.5 2.5 5]
p(2,:)=[2.5 2.5 -3.5];%[2.5 2.5 0]
p(3,:)=[8.5 2.5 2.5];%[5 2.5 2.5]
p(4,:)=[-1.5 2.5 2.5];%[0 2.5 2.5]
p(5,:)=[2.5 -3 2.5];%[2.5 0 2.5]
p(6,:)=[2.5 8 2.5];%[2.5 5 2.5]
...
p(15,:)=[2.5 2.1 6.5];%[2.5 2.1 5]
p(16,:)=[2.2 2.5 -3.5];%[2.2 2.5 0]
p(17,:)=[8.5 2.3 2.5];%[5 2.3 2.5]
p(18,:)=[-1.5 2.5 2.4];%[0 2.5 2.4]
p(19,:)=[2.6 -3 2.5];%[2.6 0 2.5]
p(20,:)=[2.5 8 2.7];%[2.5 5 2.7]
